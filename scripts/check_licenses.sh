...
python $WORKSPACE/scripts/license_checker.py --dir . --whitelist_dir $WORKSPACE/licenses_whitelist --branch $BUILD_NUMBER --fork_commit ccc0d2c5f9a5ac661e60e6eaf138de7889928b8b --parallelism 12